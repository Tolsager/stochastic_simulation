...
def bootstrap_estimation(data: np.ndarray, r: int):
    ...
    print("Bootstrap estimate of variance of the sample mean", mean_variance)

    bootstrap_medians = np.median(bootstrap_samples, axis=1)
    median_variance = np.var(bootstrap_medians)

    print("Bootstrap estimate of variance of the sample median", median_variance)
